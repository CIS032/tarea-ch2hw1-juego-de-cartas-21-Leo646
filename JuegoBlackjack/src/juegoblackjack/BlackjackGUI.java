...
public class BlackjackGUI {
     public static void main(String[] args) {
      ...
      while (true) {
          ...
          do {
             apuesta=Integer.parseInt(JOptionPane.showInputDialog("¿Cuanto dienero quieres Apostar ?  (Entre  0 y y su cantidad maxima.)"));
   ...
   static boolean playBlackjack() {
      ...
      */
      ...
      while (true) {
           ...
           JOptionPane.showInputDialog("Pedir (H) o Plantarse (S)? ");
         
           char userAction;  // El usuario responde, 'H' o 'S'.
           do {
              userAction = Character.toUpperCase( TextIO.getlnChar() );
              if (userAction != 'H' && userAction != 'S')
                 JOptionPane.showInputDialog("Por favor elija H o S:  ");
